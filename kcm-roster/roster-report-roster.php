...
class appForm_rosterSheet_listing extends Draff_Form {  // specify winner
...
function drForm_initHtml( $appData, $appGlobals, $appChain, $appEmitter ) {
  ...
  //  $appEmitter->set_menu_customize( $appChain, $appGlobals  );
    ...
    $appEmitter->addOption_styleFile('kcm-roster/kcm1css/kcm-rpt-Roster.css','all','../');
}
...
$appData = new appData_rosterSheet;
