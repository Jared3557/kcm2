...
class appForm_tallyGrid extends kcmKernel_Draff_Form {  // specify winner

function drForm_process_submit ( $scriptData, $appGlobals, $chain ) {
...
class appForm_tallyEditKid extends kcmKernel_Draff_Form {  // specify winner
