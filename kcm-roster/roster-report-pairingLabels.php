...
class appForm_pairingLabels_listing extends Draff_Form {  // specify winner
...
function drForm_initHtml( $appData, $appGlobals, $appChain, $appEmitter ) {
    ...
    $appEmitter->addOption_styleFile('kcm-roster/kcm1css/kcm-rpt-PairingLabels.css','all','../');
}
...
class appData_pairingLabels extends draff_appData {
...
$appData = new appData_pairingLabels;
