...
class appForm_signoutSheet_listing extends kcmKernel_Draff_Form {  // specify winner
...
function drForm_initData( $appData, $appGlobals, $appChain ) {
    $appData->apd_roster_program = new application_data($appGlobals);
...
function drForm_initHtml( $appData, $appGlobals, $appChain, $appEmitter ) {
    ...
    $appEmitter->emit_options->addOption_styleFile('kcm-roster/kcm1css/kcm-rpt-Sign-Out-Sheet.css','all','../');
}
